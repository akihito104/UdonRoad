...
/**
 * ColorStateLinkMovementMethod tints background at pressed by user.
 *
 * Created by akihit on 2017/01/07.
 */
class ColorStateLinkMovementMethod extends LinkMovementMethod {
